...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Movie', fields ['api_id']
        db.delete_unique(u'movie_movie', ['api_id'])


        # Changing field 'Movie.api_id'
        db.alter_column(u'movie_movie', 'api_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Movie.api_id'
        db.alter_column(u'movie_movie', 'api_id', self.gf('django.db.models.fields.BigIntegerField')(default=None, unique=True))
        # Adding unique constraint on 'Movie', fields ['api_id']
        db.create_unique(u'movie_movie', ['api_id'])
