...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'movie_movie', 'release_year', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'Movie.release_year'
        db.alter_column(u'movie_movie', 'release_year', self.gf('django.db.models.fields.DateField')(default=None))
