...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'movie_movie', 'rating', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'Movie.rating'
        db.alter_column(u'movie_movie', 'rating', self.gf('django.db.models.fields.BigIntegerField')())
